...
///
/// let result = decode_base58_ripple.crack("StVrDLaUATiyKyV", &checker, &ares::config::Config::default()).unencrypted_text;
...
mod tests {
    ...
    fn successful_decoding() {
        ...
        let result = base58_ripple_decoder.crack("StVrDLaUATiyKyV", &get_athena_checker(), &crate::config::Config::default());
