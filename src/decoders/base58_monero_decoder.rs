...
///
/// let result = decode_base58_monero.crack("StV1DL6CwTryKyV", &checker, &ares::config::Config::default()).unencrypted_text;
...
mod tests {
    ...
    fn successful_decoding() {
        ...
        let result = base58_monero_decoder.crack("StV1DL6CwTryKyV", &get_athena_checker(), &crate::config::Config::default());
