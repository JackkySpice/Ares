...
///
/// let result = decode_base58_flickr.crack("rTu1dk6cWsRYjYu", &checker, &ares::config::Config::default()).unencrypted_text;
...
mod tests {
    ...
    fn successful_decoding() {
        ...
        let result = base58_flickr_decoder.crack("rTu1dk6cWsRYjYu", &get_athena_checker(), &crate::config::Config::default());
